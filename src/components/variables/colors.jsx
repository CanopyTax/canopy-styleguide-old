		...
		return (
			<div className="bss-fixed-focus bss-card">
				...
				<div className="bss-card__body bss-caption">
					...
					<div className="bss-subheader-sm padding-bottom-20">Grayscales</div>
					<br/>
					<div className="left-md-space bss-margin-left-16">
						<div className="bss-row">
					...
					<div className="left-md-space bss-margin-left-16">
						<div className="bss-row">
							...
							<div className="bss-bg-light-gray bss-padding-8 bss-col-xs-2 bss-center-vertical bss-gray-1">.bss-gray-1</div>
							<div className="bss-col-xs-2 bss-center-vertical">@gray1</div>
						</div>
						<div className="bss-row">
							<div className="bss-bg-gray-2 bss-col-xs-2 bss-padding-8 bss-center-vertical"><span className="bss-pull-right">.bss-bg-gray-2</span>
							</div>
							<div className="bss-bg-light-gray bss-padding-8 bss-col-xs-2 bss-center-vertical bss-gray-2">.bss-gray-2</div>
							<div className="bss-col-xs-2 bss-center-vertical">@gray2</div>
						</div>
						<div className="bss-row">
							<div className="bss-bg-gray-3 bss-col-xs-2 bss-padding-8 bss-center-vertical"><span className="bss-pull-right">.bss-bg-gray-3</span>
							</div>
							<div className="bss-bg-light-gray bss-padding-8 bss-col-xs-2 bss-center-vertical bss-gray-3">.bss-gray-3</div>
							<div className="bss-col-xs-2 bss-center-vertical">@gray3</div>
						</div>
						<div className="bss-row">
							<div className="bss-bg-gray-4 bss-col-xs-2 bss-padding-8 bss-center-vertical"><span className="bss-pull-right">.bss-bg-gray-4</span><span className="bss-pull-left">HOVER</span>
							</div>
							<div className="bss-bg-light-gray bss-padding-8 bss-col-xs-2 bss-center-vertical bss-gray-4">.bss-gray-4</div>
							<div className="bss-col-xs-2 bss-center-vertical">@gray4</div>
						</div>
						<div className="bss-row">
							<div className="bss-bg-gray-5 bss-col-xs-2 bss-padding-8 bss-center-vertical"><span className="bss-pull-right">.bss-bg-gray-5</span>
							</div>
							<div className="bss-bg-light-gray bss-padding-8 bss-col-xs-2 bss-center-vertical bss-gray-5">.bss-gray-5</div>
							<div className="bss-col-xs-2 bss-center-vertical">@gray5</div>
						</div>
						<div className="bss-row">
							<div className="bss-bg-gray-6 bss-col-xs-2 bss-padding-8 bss-center-vertical"><span className="bss-pull-right">.bss-bg-gray-6</span><span className="bss-pull-left">BREAKLINES</span>
							</div>
							<div className="bss-bg-light-gray bss-padding-8 bss-col-xs-2 bss-center-vertical bss-gray-6">.bss-gray-6</div>
							<div className="bss-col-xs-2 bss-center-vertical">@gray6</div>
						</div>
						<div className="bss-row">
							<div className="bss-bg-gray-7 bss-col-xs-2 bss-padding-8 bss-center-vertical"><span className="bss-pull-right">.bss-bg-gray-7</span>
							</div>
							<div className="bss-bg-light-gray bss-padding-8 bss-col-xs-2 bss-center-vertical bss-gray-7">.bss-gray-7</div>
							<div className="bss-col-xs-2 bss-center-vertical">@gray7</div>
						</div>
						<div className="bss-row">
							<div className="bss-bg-gray-8 bss-col-xs-2 bss-padding-8 bss-center-vertical"><span className="bss-pull-right">.bss-bg-gray-8</span><span className="bss-pull-left">BREAKLINES</span>
							</div>
							<div className="bss-bg-light-gray bss-padding-8 bss-col-xs-2 bss-center-vertical bss-gray-8">.bss-gray-8</div>
							<div className="bss-col-xs-2 bss-center-vertical">@gray8</div>
						</div>
						<div className="bss-row">
							<div className="bss-bg-gray-9 bss-col-xs-2 bss-padding-8 bss-center-vertical"><span className="bss-pull-right">.bss-bg-gray-9</span>
							</div>
							<div className="bss-bg-light-gray bss-padding-8 bss-col-xs-2 bss-center-vertical bss-gray-9">.bss-gray-9</div>
							<div className="bss-col-xs-2 bss-center-vertical">@gray9</div>
						</div>
						<div className="bss-row">
							<div className="bss-bg-gray-10 bss-col-xs-2 bss-padding-8 bss-center-vertical"><span className="bss-pull-right">.bss-bg-gray-10</span>
							</div>
							<div className="bss-bg-light-gray bss-padding-8 bss-col-xs-2 bss-center-vertical bss-gray-10">.bss-gray-10</div>
							<div className="bss-col-xs-2 bss-center-vertical">@gray10</div>
						</div>
					</div>
				</div>
			</div>
