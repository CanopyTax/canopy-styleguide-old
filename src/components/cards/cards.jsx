...
<p class="cps-card L3 cps-padding-32 cps-margin-bottom-32">
	This is an L3 card.
        ...
        <div className="cps-flexible-focus cps-card cps-margin-bottom-16">
          ...
          <div className="cps-card__body">
            This card is within a flexible focus layout. This layout encourages
            a focus on a particular type of content like files or dates.
            Generally the card grows vertically rather than stacking sequential
            cards.
            <p>
            ...
            <p>
              The thinner card headers can be used by adding the class modifier
              "+thin" to the cps-card element.
            </p>
          </div>
        </div>
	...
	<div class="cps-card__body">
        ...
        <div className="cps-fixed-focus cps-card cps-margin-bottom-16">
          ...
          <div className="cps-card__body">
            ...
            focus on a particular type of content like files or dates. Generally
            the card grows vertically but does not resize horizontally with the
            screen.
            <div className="cps-card__banner cps-bg-success cps-white">
              A long banner can appear within a card
            </div>
            <p>
              Fixed focus defines a 760px width for the content. It also centers
              it. It generally does not account for navigation menus.
              <strong>
                The class name "cps-card" is what makes the card look with a
                white background.
              </strong>
            ...
            <div className="cps-col-xs-6">
              <div className="cps-fixed-masonry__card cps-card +thin">
                ...
                <div className="cps-card__body">
                  ...
                  layout and structure of the cards are the same as others. The
                  cards have a min height of 296px and depending on the content
                  cards may need manually defined max height.
                </div>
              </div>
            </div>
            <div className="cps-col-xs-6">
	...
	<div class="cps-row">
        ...
        <div className="cps-flexible-focus cps-card cps-margin-bottom-16 cps-margin-top-32">
          ...
          <div className="cps-card__body">
            The flexible masonry grid can be achieved purely in CSS or with the
            masonry JS lib available at http://masonry.desandro.com/.
            <p>
              If you want to have the CSS functionality, wrap all the cards in a
              "cps-flexible-masonry class".
            </p>
        ...
        <div className="cps-flexible-masonry cps-flexible-focus">
          <div className="cps-flexible-masonry-card">
            ...
            <div className="cps-flexible-masonry-card__body">
              ...
              landjaeger chicken, kielbasa frankfurter prosciutto ham rump tail.
              Kevin kielbasa pork, alcatra ground round spare ribs jowl
              frankfurter. Andouille alcatra biltong brisket tri-tip venison pig
              ham rump shank.
            </div>
          </div>
          <div className="cps-flexible-masonry-card">
          ...
          <div className="cps-flexible-masonry-card">
            ...
            <div className="cps-flexible-masonry-card__body">
              ...
              Kevin kielbasa pork, alcatra ground round spare ribs jowl
              frankfurter. Andouille alcatra biltong brisket tri-tip venison pig
              ham rump shank. Salami venison spare ribs shankle landjaeger
