			...
			<div>
				...
				<cp-edit-render-code
					dangerouslySetInnerHTML={{
						__html: `<p class="cps-card L1 cps-padding-32 cps-margin-bottom-32">
	This is an L1 card.
</p>
...
<p class="cps-card L3 cps-padding-32 cps-margin-bottom-32">
	This is an L3 card.
				...
				<div className="cps-flexible-focus cps-card cps-margin-bottom-16">
					<div className="cps-card__header cps-subheader">Flexible Focus cards</div>
					<div className="cps-card__body">
						This card is within a flexible focus layout. This layout encourages a focus on a particular type
						of content like files or dates. Generally the card grows vertically rather than stacking
						sequential cards.
						<p>
						...
						<p>
							The thinner card headers can be used by adding the class modifier "+thin" to the cps-card
							element.
						</p>
					</div>
				</div>
				...
				<cp-edit-render-code
					dangerouslySetInnerHTML={{
						__html: `<div class="cps-flexible-focus cps-card">
	...
	<div class="cps-card__body">
		There can be multiple body tags, generally separated by an hr
				...
				<div className="cps-flexible-focus cps-card cps-margin-bottom-16 cps-margin-top-32">
					<div className="cps-card__header cps-subheader">Fixed Focus cards</div>
				</div>

				<div className="cps-fixed-focus cps-card cps-margin-bottom-16">
					<div className="cps-card__header cps-subheader">Fixed Focus</div>
					<div className="cps-card__body">
						This card is within a fixed focus layout. This layout encourages a focus on a particular type of
						content like files or dates. Generally the card grows vertically but does not resize
						...
						<p>
							Fixed focus defines a 760px width for the content. It also centers it. It generally does not
							account for navigation menus.
							<strong>
								The class name "cps-card" is what makes the card look with a white background.
							</strong>
							This same class name is used for the card look and feel of the slat and table components.
				...
				<cp-edit-render-code
					dangerouslySetInnerHTML={{
						__html: `<div class="cps-fixed-focus cps-card">
	<div class="cps-card__header cps-subheader">
		The Header content goes here.
	</div>
	<div class="cps-card__body">
	...
	<div class="cps-card__body">
		...
		<p>
			Followed by more text.
				...
				<div className="cps-flexible-focus cps-card cps-margin-bottom-16 cps-margin-top-32">
					<div className="cps-card__header cps-subheader">Fixed Masonry cards</div>
				</div>
					...
					<div className="cps-row">
						<div className="cps-col-xs-6">
							<div className="cps-fixed-masonry__card cps-card +thin">
								...
								<div className="cps-card__body">
									These cards are within a fixed masonry layout. The layout of these cards is arranged
									with bootstrap classes. The actual layout and structure of the cards are the same as
									others. The cards have a min height of 296px and depending on the content cards may
									need manually defined max height.
								</div>
							</div>
						</div>
						<div className="cps-col-xs-6">
				...
				<cp-edit-render-code
					dangerouslySetInnerHTML={{
						__html: `<div class="cps-fixed-masonry">
	<div class="cps-row">
	...
	<div class="cps-row">
		...
		<div class="cps-col-xs-4">
			<div class="cps-fixed-masonry__card cps-card">
				...
				<div className="cps-flexible-focus cps-card cps-margin-bottom-16 cps-margin-top-32">
					<div className="cps-card__header cps-subheader">Flexible Masonry cards</div>
					<div className="cps-card__body">
						The flexible masonry grid can be achieved purely in CSS or with the masonry JS lib available at
						http://masonry.desandro.com/.
						<p>
							If you want to have the CSS functionality, wrap all the cards in a "cps-flexible-masonry
							class".
						</p>
				...
				<div className="cps-flexible-masonry cps-flexible-focus">
					<div className="cps-flexible-masonry-card">
						<div className="cps-flexible-masonry-card__title">Title of the note goes here</div>
						<div className="cps-flexible-masonry-card__body">
							Salami venison spare ribs shankle landjaeger tongue, pork loin brisket sirloin tri-tip
							turducken doner pork t-bone. Porchetta landjaeger chicken, kielbasa frankfurter prosciutto
							ham rump tail. Kevin kielbasa pork, alcatra ground round spare ribs jowl frankfurter.
							Andouille alcatra biltong brisket tri-tip venison pig ham rump shank.
						</div>
					</div>
					<div className="cps-flexible-masonry-card">
						<div className="cps-flexible-masonry-card__title">Title of the note goes here</div>
					...
					<div className="cps-flexible-masonry-card">
						<div className="cps-flexible-masonry-card__title">Title of the note goes here</div>
						<div className="cps-flexible-masonry-card__body">
							chicken, kielbasa frankfurter prosciutto ham rump tail. Kevin kielbasa pork, alcatra ground
							round spare ribs jowl frankfurter. Andouille alcatra biltong brisket tri-tip venison pig ham
							rump shank.
						</div>
					</div>
					<div className="cps-flexible-masonry-card">
						...
						<div className="cps-flexible-masonry-card__body">
							...
							turducken doner pork t-bone. Porchetta landjaeger chicken, kielbasa frankfurter prosciutto
							ham rump tail. Kevin kielbasa pork, alcatra ground round spare ribs jowl frankfurter.
							Andouille alcatra biltong brisket tri-tip venison pig ham rump shank. Salami venison spare
							ribs shankle landjaeger tongue, pork loin brisket sirloin tri-tip turducken doner pork
							t-bone. Porchetta landjaeger chicken, kielbasa frankfurter prosciutto ham rump tail. Kevin
							kielbasa pork, alcatra ground round spare ribs jowl frankfurter. Andouille alcatra biltong
				...
				<cp-edit-render-code
					dangerouslySetInnerHTML={{
						__html: `<div class="cps-flexible-masonry cps-flexible-focus">
	...
	<div class="cps-flexible-masonry-card +link">
		...
		<div class="cps-flexible-masonry-card__body">
			...
			Salami venison spare ribs shankle landjaeger tongue, pork loin brisket sirloin tri-tip turducken doner pork t-bone. Porchetta landjaeger chicken, kielbasa frankfurter prosciutto ham rump tail. Kevin kielbasa pork, alcatra ground round spare ribs jowl frankfurter. Andouille alcatra biltong brisket tri-tip venison pig ham rump shank.
				...
				<div className="cps-flexible-focus cps-card cps-margin-bottom-16 cps-margin-top-32">
					<div className="cps-card__header cps-subheader">Small Flexible Masonry cards</div>
					<div className="cps-card__body">Small cards can be created with the "+small" class modifier.</div>
				</div>

				<cp-edit-render-code
					dangerouslySetInnerHTML={{
						__html: `<div class="cps-fixed-focus">
