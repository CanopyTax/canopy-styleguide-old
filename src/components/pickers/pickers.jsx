		...
		return (
			<div>
				<div className="cps-flexible-focus cps-card">
					<div className="cps-card__header cps-subheader">Date Pickers</div>
					<div className="cps-card__body">
						<p>
							The styleguide provides some override styles for the bootstrap
							date picker. Generate a datepicker as usual with bootstrap and
							make sure that the id "cps-app" is on the body tag. The date
							picker should automatically style correctly.
						</p>
						<div
									...
									<tbody>
										<tr>
											<td colSpan="7">
												...
												<span className="month active">Mar</span>
							...
							<div className="datepicker-years" style={{ display: "none" }}>
								<table className="table-condensed">
									...
									<tbody>
										<tr>
											<td colSpan="7">
												<span className="year old">2009</span>
												<span className="year">2010</span>
												<span className="year">2011</span>
												<span className="year">2012</span>
												<span className="year">2013</span>
												<span className="year">2014</span>
												<span className="year active">2015</span>
												<span className="year">2016</span>
												<span className="year">2017</span>
												<span className="year">2018</span>
												<span className="year">2019</span>
												<span className="year new">2020</span>
											</td>
										</tr>
									</tbody>
									<tfoot>
				...
				<div className="cps-flexible-focus cps-card cps-margin-top-24">
					...
					<div className="cps-card__body">
						...
						<a href="https://github.com/CanopyTax/cp-multi-selector">
							separate repository
						</a>.
					</div>
				</div>
